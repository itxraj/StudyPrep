...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-tr from-primary-50 to-primary-100 flex items-center justify-center p-4">
            <div className="glass w-full max-w-md rounded-2xl p-8 transform transition-all shadow-2xl">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-gray-500 mt-2">Start unlocking your AI study companion</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-md text-sm font-bold text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                    >
                        {isLoading ? <span className="loader !w-5 !h-5 !border-[2px] !border-t-white !border-white/30 truncate block"></span> : 'Sign Up'}
                    </button>
                </form>
