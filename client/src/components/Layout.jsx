...
const Layout = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans relative overflow-x-hidden selection:bg-primary-500/30">
            {/* Premium Minimal SaaS Background */}
            <div className="fixed inset-0 -z-10 bg-[#fafafa] dark:bg-[#0a0a0a] transition-colors duration-500">
                {/* Subtle top glow for dark mode, like Vercel/Linear */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-primary-500/10 dark:bg-primary-500-[0.03] blur-[120px] rounded-full mix-blend-screen pointer-events-none hidden dark:block"></div>

                {/* Subtle geometric gradient for light mode */}
                <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-gradient-to-br from-primary-400/10 to-transparent blur-[100px] rounded-full mix-blend-multiply opacity-50 dark:hidden"></div>
            </div>

            <nav className="glass dark:glass-dark sticky top-0 z-50 px-6 py-4 flex justify-between items-center transition-colors duration-500 border-b border-gray-200/50 dark:border-white/5">
                <Link to="/" className="flex items-center gap-3 group">
                    ...
                    <span className="text-xl font-black bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 tracking-tight">
                        AI Study Assist
                    </span>
                </Link>
